...
<html>
	...
	<body>
		<a href="#edit-donatie" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-donatie" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${donatieInstance?.version}" />
				<fieldset class="form">
